...
import decorationSun from '@/images-br/2026/decoration-sun.svg'
...
const EvexProgram = () => {
  const programs = [
    ...
    },
    {
      ...
      img: <img css={imgClass} src={decorationStraightFlower}/>
    },
    {
      ...
      img: <img css={imgClass} src={decorationSun}/>,
          ...
          return (
            <CardComponent>
              <div className="responsive_wrapper">
                <div css={[imageWrapper(item.color)]}>
                  {item?.img}
                </div>
                <h2 className="responsive_title">{item.title}</h2>
              </div>
